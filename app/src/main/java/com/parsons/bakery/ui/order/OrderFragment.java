...
public class OrderFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        List<HashMap<String, String>> dbItems = db.executeOne("SELECT * FROM " + DBHandler.TABLE_CATEGORIES + " WHERE " + DBHandler.COLUMN_CATEGORY_LEVEL + "=0 ORDER BY " + DBHandler.COLUMN_CATEGORY_ORDERING + " ASC");
        ...
        OrderRecyclerAdapter adapter = new OrderRecyclerAdapter(root.getContext(), itemList);
