...
// all global variables
        ...
        tablenamesadapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item); 
		 ...
		 select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			// a array adapter which add values to the spinner which helps in user making changes to the table
	            	...
	            	ArrayList<Cursor> alc2=dbm.execute(Query2);
	                    				...
	                    				if(!isFinishing()){
		                    							...
		                    							.setPositiveButton("yes", 
		                  								...
		                  								public void onClick(DialogInterface dialog, int which) {
									                    		...
									                    		ArrayList<Cursor> aldropt=dbm.execute(Query6);
	                    				...
	                    				if(!isFinishing()){
		                    							...
		                    							.setPositiveButton("yes", 
		                  								...
		                  								public void onClick(DialogInterface dialog, int which) {
									                    		...
									                    		ArrayList<Cursor> aldeletet=dbm.execute(Query7);
	                    				...
	                    				if(!isFinishing()){
	                    							...
	                    							.setPositiveButton("Add", 
	                  								...
	                  								public void onClick(DialogInterface dialog, int which) {
	                  									...
	                  									ArrayList<Cursor> altc=dbm.execute(Query4);
	...
	{
		ArrayList<Cursor> alc3=dbm.execute("PRAGMA table_info("+ indexInfo.table_name+")");
				...
				new AlertDialog.Builder(AndroidDatabaseManager.this)
						...
						.setPositiveButton("Ok", 
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								//dbm.getData(Query3);
								ArrayList<Cursor> aluc=dbm.execute(Query3);
								...
								if(spinner_value.equalsIgnoreCase("Delete this row"))
								{
									...
									ArrayList<Cursor> aldc=dbm.execute(Query5);
	...
	{	
		...
		ArrayList<Cursor> alc3=dbm.execute(Query8);
    	c3=alc3.get(0);
    	//saving cursor to the static indexinfo class which can be resued by the other functions
			...
			previous.setOnClickListener(new OnClickListener()
		    {
		        ...
		        public void onClick(View v) 
		        {
		            ...
		            else
		            {
		            	...
		            	Log.d("index =", String.valueOf(indexInfo.index));
		            }
		        } 
		    });
